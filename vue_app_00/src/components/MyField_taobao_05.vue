<template>
  <div class="container">
    ...
    <div class="operateDiv">
      ...
      <!-- 密码 -->
      <mt-field placeholder="请输入密码" type="password" v-show="isUserAccount" v-model="upass" class="myinput"></mt-field>
      <!-- 短信验证码 -->
      <!-- 免费注册 -->
      <!-- 登录和切换登录方式 -->
      <div>
    ...
    methods: {
      changeLoginMethod(){
        ...
        if(this.isUserAccount){
          ...
          this.defaultAccountTxt="短信校验码登录";
        }
